...
class Video():
    ...
    def __init__(self, url: str, imagem: str, titulo: str, descricao: str, qt_visualizacao: int, qt_curtidas: int, data_publicacao: str) -> Video:
        self.__url = url
    ...
    def set_qt_visualizacao(self, qt_visualizacao: str) -> None:
        self.__qt_visualizacao = qt_visualizacao

    def set_qt_curtidas(self, qt_curtidas: str) -> None:
        self.__qt_curtidas = qt_curtidas

    def set_data_publicacao(self, data_publicacao: str) -> None:
        self.__data_publicacao = data_publicacao